...
| **[Agente Financeiro](https://github.com/EternalCodeBR/agente_financeiro)** | Controle de gastos workflow em PYTHON, API PLUGGY e integração com LLM para análise financeira *(EM CONSTRUÇÃO)*|
