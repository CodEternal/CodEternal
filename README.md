...
| **[Otimização de recálculo Excel](https://github.com/EternalCodeBR/excel-cloud-recalc-optimization)** | Recálculo de planilhas de precificação fora da nuvem: elimina o gargalo de AutoSave do OneDrive/SharePoint — de 40min–1h30 para 30 segundos |
